    ...
    if (match.groundType === 'Grass') {
      ...
      if (
        ...
        if (homeFormOnGrass.winPerc >= 75) {
          of.homeForm =
            of.homeForm +
            ` ${homeData.lastName}'s current win percentage of ${homeFormOnGrass.winPerc}% on grass courts indicates a strong start to the season on this surface. However, it remains to be seen if he can maintain this level of performance as the season progresses.`;
          of.homeForm_RO =
            of.homeForm_RO +
          ...
          of.homeForm_IT =
            of.homeForm_IT +
            ` L'attuale percentuale di vittorie di ${homeData.lastName} di ${homeFormOnGrass.winPerc}% sui campi in erba indica un forte inizio di stagione su questa superficie. Tuttavia, resta da vedere se riuscirà a mantenere questo livello di prestazioni nel corso della stagione.`;
          of.homeForm_ES =
            of.homeForm_ES +
            ` El actual porcentaje de victorias de ${homeData.lastName}% en hierba de ${homeFormOnGrass.winPerc}% indica un buen comienzo de temporada en esta superficie. Sin embargo, está por ver si puede mantener este nivel de rendimiento a medida que avance la temporada.`;
          of.homeForm_PT =
            of.homeForm_PT +
            ` A actual percentagem de vitórias de ${homeData.lastName} de ${homeFormOnGrass.winPerc}% em campos de relva indica um forte início de época nesta superfície. No entanto, resta saber se ele consegue manter este nível de desempenho à medida que a época avança.`;
          of.homeForm_FR =
            of.homeForm_FR +
            ` Le pourcentage de victoire actuel de ${homeData.lastName} de ${homeFormOnGrass.winPerc}% sur gazon indique un bon début de saison sur cette surface. Cependant, il reste à voir s'il peut maintenir ce niveau de performance au fur et à mesure que la saison avance.`;
          of.homeForm_DE =
            of.homeForm_DE +
            ` ${homeData.lastName}s aktueller Gewinnprozentsatz von ${homeFormOnGrass.winPerc}% auf Rasenplätzen deutet auf einen starken Start in die Saison auf diesem Belag hin. Es bleibt jedoch abzuwarten, ob er dieses Leistungsniveau im weiteren Verlauf der Saison halten kann.`;
          of.homeForm_CZ =
            of.homeForm_CZ +
            ` Aktuální procento vítězství ${homeData.lastName}% na travnatých kurtech ${homeFormOnGrass.winPerc}% naznačuje silný začátek sezóny na tomto povrchu. Uvidíme však, zda si tuto úroveň výkonnosti dokáže udržet i v dalším průběhu sezony.`;
          of.homeForm_PL =
            of.homeForm_PL +
            ` Aktualny procent zwycięstw ${homeData.lastName} na kortach trawiastych wynoszący ${homeFormOnGrass.winPerc}% wskazuje na dobry początek sezonu na tej nawierzchni. Jednak dopiero okaże się, czy uda mu się utrzymać ten poziom w miarę upływu sezonu.`;
        }

        if (homeFormOnGrass.winPerc < 75 && homeFormOnGrass.winPerc >= 50) {
          of.homeForm =
            of.homeForm +
            ` ${homeData.lastName}'s current win percentage of ${homeFormOnGrass.winPerc}% on grass courts indicates a promising start to the season on this surface. Nonetheless, the question remains whether he can sustain this level of performance throughout the remainder of the season.`;
          of.homeForm_RO =
            of.homeForm_RO +
          ...
          of.homeForm_IT =
            of.homeForm_IT +
            ` L'attuale percentuale di vittorie di ${homeData.lastName} di ${homeFormOnGrass.winPerc}% sui campi in erba indica un inizio di stagione promettente su questa superficie. Tuttavia, resta da chiedersi se riuscirà a mantenere questo livello di prestazioni per tutto il resto della stagione.`;
          of.homeForm_ES =
            of.homeForm_ES +
            ` El actual porcentaje de victorias de ${homeData.lastName}% en hierba de ${homeFormOnGrass.winPerc}% indica un prometedor comienzo de temporada en esta superficie. Sin embargo, la pregunta sigue siendo si podrá mantener este nivel de rendimiento durante el resto de la temporada.`;
          of.homeForm_PT =
            of.homeForm_PT +
            ` A actual percentagem de vitórias de ${homeData.lastName} de ${homeFormOnGrass.winPerc}% em campos de relva indica um início de época promissor nesta superfície. No entanto, resta saber se ele consegue manter este nível de desempenho durante o resto da época.`;
          of.homeForm_FR =
            of.homeForm_FR +
            ` Le pourcentage de victoire actuel de ${homeData.lastName} de ${homeFormOnGrass.winPerc}% sur gazon indique un début de saison prometteur sur cette surface. Néanmoins, la question reste de savoir s'il peut maintenir ce niveau de performance jusqu'à la fin de la saison.`;
          of.homeForm_DE =
            of.homeForm_DE +
            ` ${homeData.lastName}s aktueller Gewinnprozentsatz von ${homeFormOnGrass.winPerc}% auf Rasenplätzen deutet auf einen vielversprechenden Start in die Saison auf diesem Belag hin. Dennoch bleibt die Frage, ob er dieses Leistungsniveau über den Rest der Saison halten kann.`;
          of.homeForm_CZ =
            of.homeForm_CZ +
            ` Aktuální procento vítězství ${homeData.lastName}% na travnatých kurtech ${homeFormOnGrass.winPerc}% naznačuje slibný začátek sezóny na tomto povrchu. Otázkou nicméně zůstává, zda si tuto úroveň výkonnosti dokáže udržet po zbytek sezony.`;
          of.homeForm_PL =
            of.homeForm_PL +
            ` Aktualny procent zwycięstw ${homeData.lastName} na trawie wynoszący ${homeFormOnGrass.winPerc}% wskazuje na obiecujący początek sezonu na tej nawierzchni. Niemniej jednak pozostaje pytanie, czy będzie on w stanie utrzymać ten poziom gry przez resztę sezonu.`;
        }

        if (homeFormOnGrass.winPerc < 50 && homeFormOnGrass.winPerc >= 40) {
          of.homeForm =
            of.homeForm +
            ` ${homeData.properName}'s current win percentage of ${homeFormOnGrass.winPerc}% on grass courts suggests a challenging start to the season on this surface. However, the uncertainty still lingers over whether he can recover and showcase a better level of performance in the upcoming matches of the season.`;
          of.homeForm_RO =
            of.homeForm_RO +
            ` Procentul actual de victorii al lui ${homeData.properName} de ${homeFormOnGrass.winPerc}% pe iarbă sugerează un început de sezon dificil pe această suprafață. Cu toate acestea, încă persistă incertitudinea cu privire la posibilitatea ca el să-și revină și să afișeze un nivel mai bun de performanță în următoarele meciuri ale sezonului.`;
          of.homeForm_IT =
            of.homeForm_IT +
            ` L'attuale percentuale di vittorie di ${homeData.properName} di ${homeFormOnGrass.winPerc}% sui campi in erba suggerisce un inizio di stagione difficile su questa superficie. Tuttavia, non si sa se riuscirà a riprendersi e a mostrare un livello di prestazioni migliore nelle prossime partite della stagione.`;
          of.homeForm_ES =
            of.homeForm_ES +
            ` El actual porcentaje de victorias de ${homeData.properName}% de ${homeFormOnGrass.winPerc}% en pistas de hierba sugiere un inicio de temporada complicado en esta superficie. Sin embargo, aún persiste la incertidumbre sobre si podrá recuperarse y mostrar un mejor nivel de rendimiento en los próximos partidos de la temporada.`;
          of.homeForm_PT =
            of.homeForm_PT +
            ` A actual percentagem de vitórias de ${homeData.properName} de ${homeFormOnGrass.winPerc}% em campos de relva sugere um início de época difícil nesta superfície. No entanto, a incerteza continua a pairar sobre se ele consegue recuperar e mostrar um melhor nível de desempenho nos próximos jogos da época.`;
          of.homeForm_FR =
            of.homeForm_FR +
            ` Le pourcentage de victoire actuel de ${homeData.properName} de ${homeFormOnGrass.winPerc}% sur gazon suggère un début de saison difficile sur cette surface. Cependant, l'incertitude persiste quant à sa capacité à se rétablir et à afficher un meilleur niveau de performance lors des prochains matches de la saison.`;
          of.homeForm_DE =
            of.homeForm_DE +
            ` ${homeData.properName}s aktuelle Siegquote von ${homeFormOnGrass.winPerc}% auf Rasenplätzen deutet auf einen schwierigen Saisonstart auf diesem Belag hin. Es bleibt jedoch ungewiss, ob er sich erholen und in den kommenden Spielen der Saison eine bessere Leistung zeigen kann.`;
          of.homeForm_CZ =
            of.homeForm_CZ +
            ` Aktuální procento výher ${homeData.properName}% na travnatých kurtech naznačuje náročný začátek sezóny na tomto povrchu. Stále však přetrvává nejistota, zda se dokáže zotavit a předvést lepší výkonnost v nadcházejících zápasech sezony.`;
          of.homeForm_PL =
            of.homeForm_PL +
            ` Aktualny procent wygranych ${homeData.properName}% na kortach trawiastych sugeruje trudny początek sezonu na tej nawierzchni. Wciąż jednak nie wiadomo, czy uda mu się odzyskać formę i zaprezentować lepszy poziom w nadchodzących meczach sezonu.`;
        }

        if (homeFormOnGrass.winPerc < 40) {
          of.homeForm =
            of.homeForm +
            ` ${homeData.lastName}'s current win percentage of ${homeFormOnGrass.winPerc}% on grass courts suggests a disappointing start to the season on this surface. In order to improve his results, he needs to step up his game and perform at a higher level.`;
          of.homeForm_RO =
            of.homeForm_RO +
          ...
          of.homeForm_IT =
            of.homeForm_IT +
            ` L'attuale percentuale di vittorie di ${homeData.lastName} di ${homeFormOnGrass.winPerc}% sui campi in erba suggerisce un inizio di stagione deludente su questa superficie. Per migliorare i suoi risultati, ha bisogno di migliorare il suo gioco e di esibirsi a un livello più alto.`;
          of.homeForm_ES =
            of.homeForm_ES +
            ` El actual porcentaje de victorias de ${homeData.lastName}% en hierba de ${homeFormOnGrass.winPerc}% sugiere un inicio de temporada decepcionante en esta superficie. Para mejorar sus resultados, necesita intensificar su juego y rendir a un nivel superior.`;
          of.homeForm_PT =
            of.homeForm_PT +
            ` A actual percentagem de vitórias de ${homeData.lastName} de ${homeFormOnGrass.winPerc}% em campos de relva sugere um início de época decepcionante nesta superfície. Para melhorar os seus resultados, ele precisa de melhorar o seu jogo e actuar a um nível mais elevado.`;
          of.homeForm_FR =
            of.homeForm_FR +
            ` Le pourcentage de victoires de ${homeData.lastName} sur gazon de ${homeFormOnGrass.winPerc}% suggère un début de saison décevant sur cette surface. Pour améliorer ses résultats, il doit intensifier son jeu et se montrer plus performant.`;
          of.homeForm_DE =
            of.homeForm_DE +
            ` ${homeData.lastName}s aktueller Gewinnprozentsatz von ${homeFormOnGrass.winPerc}% auf Rasenplätzen deutet auf einen enttäuschenden Start in die Saison auf diesem Belag hin. Um seine Ergebnisse zu verbessern, muss er sein Spiel intensivieren und auf einem höheren Niveau spielen.`;
          of.homeForm_CZ =
            of.homeForm_CZ +
            ` Aktuální procento vítězství ${homeData.lastName}% na travnatých kurtech naznačuje neuspokojivý začátek sezóny na tomto povrchu. Aby své výsledky zlepšil, musí svou hru zintenzivnit a předvádět výkony na vyšší úrovni.`;
          of.homeForm_PL =
            of.homeForm_PL +
            ` Aktualny procent zwycięstw ${homeData.lastName} na kortach trawiastych wynoszący ${homeFormOnGrass.winPerc}% sugeruje rozczarowujący początek sezonu na tej nawierzchni. Aby poprawić swoje wyniki, musi on wzmocnić swoją grę i występować na wyższym poziomie.`;
        }
      }
      ...
      if (homeFormOnGrass.totalMatches >= 5) {
        // console.log(`win perc ${homeFormOnGrass.winPerc}%`);
        of.homeForm = `In the current season, ${homeData.properName} has played a sufficient number of matches on grass courts, allowing for a comprehensive analysis of his form on this surface.`;
        ...
        if (homeFormOnGrass.winPerc >= 80) {
          of.homeForm =
            of.homeForm +
            ` His win rate on grass courts currently stands at an impressive ${homeFormOnGrass.winPerc}%, having emerged victorious in ${homeFormOnGrass.won} matches and suffered defeat in ${homeFormOnGrass.lost}. This performance can certainly be regarded as excellent.`;
          of.homeForm_RO =
            of.homeForm_RO +
        ...
        if (homeFormOnGrass.winPerc < 50) {
          of.homeForm =
            of.homeForm +
            ` His current form on grass courts is not that good, with only a ${homeFormOnGrass.winPerc}% win rate in his matches played.`;
          of.homeForm_RO =
            of.homeForm_RO +
      ...
      if (
        ...
        if (awayFormOnGrass.winPerc >= 75) {
          of.awayForm =
            of.awayForm +
            ` It appears that ${awayData.lastName} has had a strong start to the season on grass courts, as indicated by his current win percentage of ${awayFormOnGrass.winPerc}%. Nevertheless, it remains to be seen whether he can sustain this level of performance as the season moves forward.`;
          of.awayForm_RO =
            of.awayForm_RO +
          ...
          of.awayForm_IT =
            of.awayForm_IT +
            ` Sembra che ${awayData.lastName} abbia iniziato bene la stagione sui campi in erba, come indica la sua attuale percentuale di vittorie di ${awayFormOnGrass.winPerc}%. Tuttavia, resta da vedere se riuscirà a mantenere questo livello di prestazioni nel corso della stagione.`;
          of.awayForm_ES =
            of.awayForm_ES +
            ` Parece que ${awayData.lastName} ha tenido un buen comienzo de temporada en hierba, como indica su actual porcentaje de victorias de ${awayFormOnGrass.winPerc}%. No obstante, queda por ver si puede mantener este nivel de rendimiento a medida que avance la temporada.`;
          of.awayForm_PT =
            of.awayForm_PT +
            ` Parece que o ${awayData.lastName} teve um forte início de época em campos de relva, como indicado pela sua actual percentagem de vitórias de ${awayFormOnGrass.winPerc}%. No entanto, resta saber se ele consegue manter este nível de desempenho à medida que a época avança.`;
          of.awayForm_FR =
            of.awayForm_FR +
            ` Il semble que ${awayData.lastName} ait connu un bon début de saison sur gazon, comme l'indique son pourcentage de victoire actuel de ${awayFormOnGrass.winPerc}%. Néanmoins, il reste à voir s'il peut maintenir ce niveau de performance tout au long de la saison.`;
          of.awayForm_DE =
            of.awayForm_DE +
            ` Es scheint, dass ${awayData.lastName} einen starken Start in die Saison auf Rasenplätzen hatte, wie seine aktuelle Siegquote von ${awayFormOnGrass.winPerc}% zeigt. Es bleibt jedoch abzuwarten, ob er dieses Leistungsniveau im weiteren Verlauf der Saison halten kann.`;
          of.awayForm_CZ =
            of.awayForm_CZ +
            ` Zdá se, že ${awayData.lastName} má za sebou silný začátek sezóny na travnatých kurtech, jak ukazuje jeho aktuální procento výher ${awayFormOnGrass.winPerc}%. Nicméně se teprve ukáže, zda si tuto úroveň výkonnosti dokáže udržet i v dalším průběhu sezóny.`;
          of.awayForm_PL =
            of.awayForm_PL +
            ` Wygląda na to, że ${awayData.lastName}ma dobry początek sezonu na kortach trawiastych, na co wskazuje jego aktualny procent wygranych ${awayFormOnGrass.winPerc}%. Niemniej jednak, dopiero okaże się, czy uda mu się utrzymać ten poziom w dalszej części sezonu.`;
        }

        if (awayFormOnGrass.winPerc < 75 && awayFormOnGrass.winPerc >= 50) {
          of.awayForm =
            of.awayForm +
            ` The present win percentage of ${awayFormOnGrass.winPerc}% on grass courts by ${awayData.lastName} presents a promising start to the season on this surface. Nevertheless, it raises the question of whether he can maintain this level of performance for the rest of the season.`;
          of.awayForm_RO =
            of.awayForm_RO +
          ...
          of.awayForm_IT =
            of.awayForm_IT +
            ` L'attuale percentuale di vittorie di ${awayFormOnGrass.winPerc}% sui campi in erba di ${awayData.lastName} rappresenta un inizio di stagione promettente su questa superficie. Tuttavia, ci si chiede se possa mantenere questo livello di prestazioni per il resto della stagione.`;
          of.awayForm_ES =
            of.awayForm_ES +
            ` El actual porcentaje de victorias de ${awayFormOnGrass.winPerc}% en pistas de hierba de ${awayData.lastName} presenta un prometedor comienzo de temporada en esta superficie. Sin embargo, plantea la cuestión de si podrá mantener este nivel de rendimiento durante el resto de la temporada.`;
          of.awayForm_PT =
            of.awayForm_PT +
            ` A actual percentagem de vitórias de ${awayFormOnGrass.winPerc}% em campos de relva por ${awayData.lastName} apresenta um início de época promissor nesta superfície. No entanto, levanta a questão de saber se ele consegue manter este nível de desempenho durante o resto da época.`;
          of.awayForm_FR =
            of.awayForm_FR +
            ` Le pourcentage de victoire actuel de ${awayFormOnGrass.winPerc}% sur gazon de ${awayData.lastName} représente un début de saison prometteur sur cette surface. Néanmoins, la question se pose de savoir s'il peut maintenir ce niveau de performance pour le reste de la saison.`;
          of.awayForm_DE =
            of.awayForm_DE +
            ` Die aktuelle Gewinnquote von ${awayFormOnGrass.winPerc}% auf Rasenplätzen von ${awayData.lastName} stellt einen vielversprechenden Saisonstart auf diesem Belag dar. Es stellt sich jedoch die Frage, ob er dieses Leistungsniveau für den Rest der Saison halten kann.`;
          of.awayForm_CZ =
            of.awayForm_CZ +
            ` Současné procento vítězství ${awayFormOnGrass.winPerc}% na travnatých kurtech od ${awayData.lastName} představuje slibný začátek sezóny na tomto povrchu. Nicméně se nabízí otázka, zda si tuto úroveň výkonnosti dokáže udržet po zbytek sezóny.`;
          of.awayForm_PL =
            of.awayForm_PL +
            ` Aktualny procent wygranych ${awayFormOnGrass.winPerc}% na kortach trawiastych przez ${awayData.lastName} prezentuje obiecujący początek sezonu na tej nawierzchni. Niemniej jednak, rodzi się pytanie, czy jest on w stanie utrzymać ten poziom wyników przez resztę sezonu.`;
        }

        if (awayFormOnGrass.winPerc < 50 && awayFormOnGrass.winPerc >= 40) {
          of.awayForm =
            of.awayForm +
            ` The win percentage of ${awayFormOnGrass.winPerc}% on grass courts by ${awayData.properName} portrays a tough start to the season on this surface. Nonetheless, there is still uncertainty as to whether he can bounce back and deliver a better performance in the upcoming matches of the season.`;
          of.awayForm_RO =
            of.awayForm_RO +
          ...
          of.awayForm_IT =
            of.awayForm_IT +
            ` La percentuale di vittorie di ${awayFormOnGrass.winPerc}% sui campi in erba da parte di ${awayData.properName} evidenzia un inizio di stagione difficile su questa superficie. Ciononostante, non si sa se riuscirà a riprendersi e a fornire prestazioni migliori nelle prossime partite della stagione.`;
          of.awayForm_ES =
            of.awayForm_ES +
            ` El porcentaje de victorias de ${awayFormOnGrass.winPerc}% en pistas de hierba de ${awayData.properName} retrata un duro comienzo de temporada en esta superficie. No obstante, aún no se sabe si podrá recuperarse y ofrecer un mejor rendimiento en los próximos partidos de la temporada.`;
          of.awayForm_PT =
            of.awayForm_PT +
            ` A percentagem de vitórias de ${awayFormOnGrass.winPerc}% em campos de relva por ${awayData.properName} retrata um início de época difícil nesta superfície. No entanto, ainda não se sabe se ele conseguirá recuperar e apresentar um melhor desempenho nos próximos jogos da época.`;
          of.awayForm_FR =
            of.awayForm_FR +
            ` Le pourcentage de victoire de ${awayFormOnGrass.winPerc}% sur gazon de ${awayData.properName} témoigne d'un début de saison difficile sur cette surface. Néanmoins, l'incertitude demeure quant à sa capacité à rebondir et à réaliser de meilleures performances lors des prochains matches de la saison.`;
          of.awayForm_DE =
            of.awayForm_DE +
            ` Die Gewinnquote von ${awayFormOnGrass.winPerc}% auf Rasenplätzen von ${awayData.properName} zeigt einen schwierigen Saisonstart auf diesem Belag. Dennoch bleibt ungewiss, ob er sich davon erholen und in den kommenden Spielen der Saison eine bessere Leistung zeigen kann.`;
          of.awayForm_CZ =
            of.awayForm_CZ +
            ` Procento výher ${awayFormOnGrass.winPerc}% na travnatých kurtech podle ${awayData.properName} ukazuje těžký začátek sezóny na tomto povrchu. Nicméně stále panuje nejistota, zda se dokáže odrazit ode dna a v nadcházejících zápasech sezóny podávat lepší výkony.`;
          of.awayForm_PL =
            of.awayForm_PL +
            ` Procent wygranych ${awayFormOnGrass.winPerc}% na kortach trawiastych przez ${awayData.properName} obrazuje trudny początek sezonu na tej nawierzchni. Niemniej jednak, wciąż nie ma pewności, czy uda mu się odbić od dna i zapewnić lepsze wyniki w nadchodzących meczach sezonu.`;
        }

        if (awayFormOnGrass.winPerc < 40) {
          of.awayForm =
            of.awayForm +
            ` It seems that ${awayData.lastName} has had a discouraging start to the season on grass courts, with a current win percentage of ${awayFormOnGrass.winPerc}%. To enhance his results, the player will need to elevate his game.`;
          of.awayForm_RO =
            of.awayForm_RO +
            ` Se pare că ${awayData.lastName} a avut un început de sezon descurajator pe iarbă, cu un procentaj actual de victorii de ${awayFormOnGrass.winPerc}%. Pentru a-și îmbunătăți rezultatele, jucătorul va trebui să își ridice nivelul de joc.`;
          of.awayForm_IT =
            of.awayForm_IT +
            ` Sembra che ${awayData.lastName} abbia avuto un inizio di stagione scoraggiante sui campi in erba, con una percentuale di vittorie attuale di ${awayFormOnGrass.winPerc}%. Per migliorare i suoi risultati, il giocatore dovrà migliorare il suo gioco.`;
          of.awayForm_ES =
            of.awayForm_ES +
            ` Parece que ${awayData.lastName} ha tenido un comienzo de temporada desalentador en pistas de hierba, con un porcentaje de victorias actual de ${awayFormOnGrass.winPerc}%. Para mejorar sus resultados, el jugador necesitará elevar su juego.`;
          of.awayForm_PT =
            of.awayForm_PT +
            ` Parece que ${awayData.lastName} teve um início de época desanimador em campos de relva, com uma percentagem de vitórias actual de ${awayFormOnGrass.winPerc}%. Para melhorar os seus resultados, o jogador terá de elevar o seu jogo.`;
          of.awayForm_FR =
            of.awayForm_FR +
            ` Il semble que ${awayData.lastName} ait connu un début de saison décourageant sur gazon, avec un pourcentage de victoire actuel de ${awayFormOnGrass.winPerc}%. Pour améliorer ses résultats, le joueur devra élever son niveau de jeu.`;
          of.awayForm_DE =
            of.awayForm_DE +
            ` Es scheint, dass ${awayData.lastName} einen entmutigenden Start in die Saison auf Rasenplätzen hatte, mit einer aktuellen Gewinnquote von ${awayFormOnGrass.winPerc}%. Um seine Ergebnisse zu verbessern, muss der Spieler sein Spiel verbessern.`;
          of.awayForm_CZ =
            of.awayForm_CZ +
            ` Zdá se, že ${awayData.lastName} má za sebou neutěšený začátek sezóny na travnatých kurtech s aktuálním procentem výher ${awayFormOnGrass.winPerc}%. Aby hráč zlepšil své výsledky, bude muset svou hru zkvalitnit.`;
          of.awayForm_PL =
            of.awayForm_PL +
            ` Wygląda na to, że ${awayData.lastName}ma zniechęcający początek sezonu na kortach trawiastych, z aktualnym procentem zwycięstw ${awayFormOnGrass.winPerc}%. Aby poprawić swoje wyniki, zawodnik będzie musiał podnieść poziom swojej gry.`;
        }
      }
      ...
      if (awayFormOnGrass.totalMatches >= 5) {
        // console.log(`win perc ${awayFormOnGrass.winPerc}%`);
        of.awayForm = `During this season, ${awayData.properName} has played enough matches on grass courts, thus enabling a thorough evaluation of his form on this surface.`;
        ...
        if (awayFormOnGrass.winPerc < 50) {
          of.awayForm =
            of.awayForm +
            ` ${awayData.properName}'s performance on grass courts is not good, with a win rate of only ${awayFormOnGrass.winPerc}% in his matches played.`;
