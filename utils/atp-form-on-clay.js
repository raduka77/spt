    ...
    if (
      ...
      if (homeFormOnClay.totalMatches >= 1 && homeFormOnClay.totalMatches < 5) {
        ...
        if (homeFormOnClay.winPerc < 75 && homeFormOnClay.winPerc >= 50) {
          of.homeForm =
            of.homeForm +
            ` ${homeData.lastName}'s current win percentage of ${homeFormOnClay.winPerc}% on clay indicates a promising start to the season on this surface. Nonetheless, the question remains whether he can sustain this level of performance throughout the remainder of the season.`;
          of.homeForm_RO =
            of.homeForm_RO +
          ...
          of.homeForm_FR =
            of.homeForm_FR +
            ` Le pourcentage de victoire de ${homeData.lastName} sur terre battue, qui est actuellement de ${homeFormOnClay.winPerc}%, indique un début de saison prometteur sur cette surface. Néanmoins, la question reste de savoir s'il peut maintenir ce niveau de performance jusqu'à la fin de la saison.`;
          of.homeForm_DE =
            of.homeForm_DE +
        ...
        if (homeFormOnClay.winPerc < 50 && homeFormOnClay.winPerc >= 40) {
          of.homeForm =
            of.homeForm +
            ` ${homeData.properName}'s current win percentage of ${homeFormOnClay.winPerc}% on clay suggests a challenging start to the season on this surface. However, the uncertainty still lingers over whether he can recover and showcase a better level of performance in the upcoming matches of the season.`;

          of.homeForm_RO =
            of.homeForm_RO +
            ` Procentul actual de victorii al lui ${homeData.properName} de ${homeFormOnClay.winPerc}% pe zgură sugerează un început de sezon dificil pe această suprafață. Cu toate acestea, încă persistă incertitudinea cu privire la posibilitatea ca el să-și revină și să afișeze un nivel mai bun de performanță în următoarele meciuri ale sezonului.`;
          of.homeForm_IT =
            of.homeForm_IT +
            ` L'attuale percentuale di vittorie di ${homeData.properName} di ${homeFormOnClay.winPerc}% sulla terra battuta suggerisce un inizio di stagione difficile su questa superficie. Tuttavia, non si sa se riuscirà a riprendersi e a mostrare un livello di prestazioni migliore nelle prossime partite della stagione.`;
          of.homeForm_ES =
            of.homeForm_ES +
            ` El actual porcentaje de victorias de ${homeData.properName} sobre tierra batida de ${homeFormOnClay.winPerc}% sugiere un inicio de temporada complicado en esta superficie. Sin embargo, aún persiste la incertidumbre sobre si podrá recuperarse y mostrar un mejor nivel de rendimiento en los próximos partidos de la temporada.`;
          of.homeForm_PT =
            of.homeForm_PT +
            ` A actual percentagem de vitórias de ${homeData.properName} de ${homeFormOnClay.winPerc}% no saibro sugere um início de época difícil nesta superfície. No entanto, a incerteza continua a pairar sobre se ele consegue recuperar e mostrar um melhor nível de desempenho nos próximos jogos da época.`;
          of.homeForm_FR =
            of.homeForm_FR +
          ...
          of.homeForm_DE =
            of.homeForm_DE +
            ` ${homeData.properName}s aktuelle Siegquote von ${homeFormOnClay.winPerc}% auf Sand deutet auf einen schwierigen Saisonstart auf diesem Belag hin. Es bleibt jedoch ungewiss, ob er sich davon erholen und in den kommenden Matches der Saison ein besseres Leistungsniveau zeigen kann.`;
          of.homeForm_CZ =
            of.homeForm_CZ +
            ` Aktuální procento vítězství ${homeData.properName} na antuce naznačuje náročný začátek sezóny na tomto povrchu. Stále však přetrvává nejistota, zda se dokáže zotavit a předvést lepší výkonnost v nadcházejících zápasech sezony.`;
          of.homeForm_PL =
            of.homeForm_PL +
            ` Aktualny procent zwycięstw ${homeData.properName} na glinie wynoszący ${homeFormOnClay.winPerc}% sugeruje trudny początek sezonu na tej nawierzchni. Wciąż jednak nie wiadomo, czy uda mu się odzyskać formę i zaprezentować lepszy poziom w nadchodzących meczach sezonu.`;
        }

        if (homeFormOnClay.winPerc < 40) {
          of.homeForm =
            of.homeForm +
            ` ${homeData.lastName}'s current win percentage of ${homeFormOnClay.winPerc}% on clay suggests a disappointing start to the season on this surface. In order to improve his results, he needs to step up his game and perform at a higher level.`;

          of.homeForm_RO =
            of.homeForm_RO +
            ` Procentul actual de victorii al lui ${homeData.lastName} de ${homeFormOnClay.winPerc}% pe zgură sugerează un început dezamăgitor de sezon pe această suprafață. Pentru a-și îmbunătăți rezultatele, el trebuie să își intensifice jocul și să performeze la un nivel mai ridicat.`;
          of.homeForm_IT =
            of.homeForm_IT +
            ` L'attuale percentuale di vittorie di ${homeData.lastName} di ${homeFormOnClay.winPerc}% sulla terra battuta suggerisce un inizio di stagione deludente su questa superficie. Per migliorare i suoi risultati, ha bisogno di migliorare il suo gioco e di esibirsi a un livello più alto.`;
          of.homeForm_ES =
            of.homeForm_ES +
            ` El actual porcentaje de victorias de ${homeData.lastName} en tierra batida de ${homeFormOnClay.winPerc}% sugiere un inicio de temporada decepcionante en esta superficie. Para mejorar sus resultados, necesita intensificar su juego y rendir a un nivel superior.`;
          of.homeForm_PT =
            of.homeForm_PT +
            ` A actual percentagem de vitórias de ${homeData.lastName} de ${homeFormOnClay.winPerc}% no saibro sugere um início de época decepcionante nesta superfície. Para melhorar os seus resultados, ele precisa de melhorar o seu jogo e actuar a um nível mais elevado.`;
          of.homeForm_FR =
            of.homeForm_FR +
            ` Le pourcentage de victoire actuel de ${homeData.lastName} de ${homeFormOnClay.winPerc}% sur terre battue suggère un début de saison décevant sur cette surface. Afin d'améliorer ses résultats, il doit intensifier son jeu et se montrer plus performant.`;
          of.homeForm_DE =
            of.homeForm_DE +
            ` ${homeData.lastName}'s aktueller Gewinnprozentsatz von ${homeFormOnClay.winPerc}% auf Sand deutet auf einen enttäuschenden Start in die Saison auf diesem Belag hin. Um seine Ergebnisse zu verbessern, muss er sein Spiel verbessern und auf einem höheren Niveau spielen.`;
          of.homeForm_CZ =
            of.homeForm_CZ +
            ` Aktuální procento vítězství ${homeData.lastName} na antuce naznačuje neuspokojivý začátek sezóny na tomto povrchu. Aby své výsledky zlepšil, musí svou hru zintenzivnit a předvádět výkony na vyšší úrovni.`;
          of.homeForm_PL =
            of.homeForm_PL +
            ` Aktualny procent zwycięstw ${homeData.lastName} na glinie wynoszący ${homeFormOnClay.winPerc}% sugeruje rozczarowujący początek sezonu na tej nawierzchni. Aby poprawić swoje wyniki, musi on wzmocnić swoją grę i występować na wyższym poziomie.`;
        }
      }
      ...
      if (homeFormOnClay.totalMatches >= 5) {
        ...
        if (homeFormOnClay.winPerc >= 80) {
          of.homeForm =
            of.homeForm +
            ` His win rate on clay currently stands at an impressive ${homeFormOnClay.winPerc}%, having emerged victorious in ${homeFormOnClay.won} matches and suffered defeat in ${homeFormOnClay.lost}. This performance can certainly be regarded as excellent.`;
        ...
        if (homeFormOnClay.winPerc < 50) {
          of.homeForm =
            of.homeForm +
            ` His current form on clay courts is less than ideal, with only a ${homeFormOnClay.winPerc}% win rate in his matches played.`;

          of.homeForm_RO =
            of.homeForm_RO +
            ` Forma sa actuală pe terenurile de zgură nu este bună, cu o rată de victorie de doar ${homeFormOnClay.winPerc}% în meciurile jucate.`;
          of.homeForm_IT =
            of.homeForm_IT +
            ` La sua forma attuale sui campi in terra battuta non è buona, con solo un ${homeFormOnClay.winPerc}% di vittorie nei suoi match giocati.`;
          of.homeForm_ES =
            of.homeForm_ES +
            ` Su forma actual en pistas de tierra batida no es buena, con sólo un ${homeFormOnClay.winPerc}% de victorias en sus partidos jugados.`;
          of.homeForm_PT =
            of.homeForm_PT +
            ` A sua forma actual em campos de terra batida não é boa, com uma taxa de vitórias de apenas ${homeFormOnClay.winPerc}% nos jogos disputados.`;
          of.homeForm_FR =
            of.homeForm_FR +
            ` Sa forme actuelle sur terre battue n'est pas bonne, avec seulement ${homeFormOnClay.winPerc}% de victoires dans les matches qu'il a joués.`;
          of.homeForm_DE =
            of.homeForm_DE +
            ` Seine derzeitige Form auf Sandplätzen ist nicht gut, mit einer Gewinnquote von nur ${homeFormOnClay.winPerc}% in seinen gespielten Matches.`;
          of.homeForm_CZ =
            of.homeForm_CZ +
            ` Jeho současná forma na antukových kurtech není dobrá, v odehraných zápasech má pouze ${homeFormOnClay.winPerc}% úspěšnost.`;
          of.homeForm_PL =
            of.homeForm_PL +
            ` Jego obecna forma na kortach glinianych nie jest dobra, z zaledwie ${homeFormOnClay.winPerc}% wskaźnikiem wygranych w swoich rozegranych meczach.`;
      ...
      if (awayFormOnClay.totalMatches >= 1 && awayFormOnClay.totalMatches < 5) {
        ...
        if (awayFormOnClay.winPerc >= 75) {
          of.awayForm =
            of.awayForm +
            ` It appears that ${awayData.lastName} has had a strong start to the season on clay, as indicated by his current win percentage of ${awayFormOnClay.winPerc}%. Nevertheless, it remains to be seen whether he can sustain this level of performance as the season moves forward.`;
          ...
          of.awayForm_IT =
            of.awayForm_IT +
            ` Sembra che ${awayData.lastName} abbia iniziato bene la stagione sulla terra battuta, come indica la sua attuale percentuale di vittorie di ${awayFormOnClay.winPerc}%. Tuttavia, resta da vedere se riuscirà a mantenere questo livello di prestazioni nel corso della stagione.`;
          of.awayForm_ES =
            of.awayForm_ES +
            ` Parece que ${awayData.lastName} ha tenido un buen comienzo de temporada en tierra batida, como indica su actual porcentaje de victorias de ${awayFormOnClay.winPerc}%. Sin embargo, queda por ver si puede mantener este nivel de rendimiento a medida que avance la temporada.`;
          of.awayForm_PT =
            of.awayForm_PT +
            ` Parece que ${awayData.lastName} teve um forte início de época no saibro, como indicado pela sua actual percentagem de vitórias de ${awayFormOnClay.winPerc}%. No entanto, resta saber se ele consegue manter este nível de desempenho à medida que a temporada avança.`;
          of.awayForm_FR =
            of.awayForm_FR +
            ` Il semble que ${awayData.lastName} ait connu un bon début de saison sur terre battue, comme l'indique son pourcentage de victoire actuel de ${awayFormOnClay.winPerc}%. Néanmoins, il reste à voir s'il peut maintenir ce niveau de performance tout au long de la saison.`;
          of.awayForm_DE =
            of.awayForm_DE +
            ` Es scheint, dass ${awayData.lastName} einen starken Start in die Saison auf Sand hatte, wie seine aktuelle Siegquote von ${awayFormOnClay.winPerc}% zeigt. Es bleibt jedoch abzuwarten, ob er dieses Leistungsniveau im weiteren Verlauf der Saison halten kann.`;
          of.awayForm_CZ =
            of.awayForm_CZ +
            ` Zdá se, že ${awayData.lastName} má za sebou silný začátek sezóny na antuce, jak ukazuje jeho aktuální procento výher ${awayFormOnClay.winPerc}%. Nicméně se teprve ukáže, zda si tuto úroveň výkonnosti dokáže udržet i v dalším průběhu sezóny.`;
          of.awayForm_PL =
            of.awayForm_PL +
            ` Wygląda na to, że ${awayData.lastName}ma dobry początek sezonu na clayu, na co wskazuje jego obecny procent wygranych ${awayFormOnClay.winPerc}%. Niemniej jednak, dopiero się okaże, czy będzie w stanie utrzymać ten poziom wyników w trakcie sezonu.`;
        }

        if (awayFormOnClay.winPerc < 75 && awayFormOnClay.winPerc >= 50) {
          of.awayForm =
            of.awayForm +
            ` The present win percentage of ${awayFormOnClay.winPerc}% on clay by ${awayData.lastName} presents a promising start to the season on this surface. Nevertheless, it raises the question of whether he can maintain this level of performance for the rest of the season.`;
          ...
          of.awayForm_IT =
            of.awayForm_IT +
            ` L'attuale percentuale di vittorie di ${awayFormOnClay.winPerc}% sulla terra battuta di ${awayData.lastName} rappresenta un inizio di stagione promettente su questa superficie. Tuttavia, ci si chiede se possa mantenere questo livello di prestazioni per il resto della stagione.`;
          of.awayForm_ES =
            of.awayForm_ES +
            ` El actual porcentaje de victorias de ${awayFormOnClay.winPerc}% en tierra batida de ${awayData.lastName} presenta un prometedor comienzo de temporada en esta superficie. Sin embargo, plantea la cuestión de si podrá mantener este nivel de rendimiento durante el resto de la temporada.`;
          of.awayForm_PT =
            of.awayForm_PT +
            ` A actual percentagem de vitórias de ${awayFormOnClay.winPerc}% no saibro por ${awayData.lastName} apresenta um início de época promissor nesta superfície. No entanto, levanta a questão de saber se ele consegue manter este nível de desempenho durante o resto da época.`;
          of.awayForm_FR =
            of.awayForm_FR +
            ` Le pourcentage de victoire actuel de ${awayFormOnClay.winPerc}% sur terre battue de ${awayData.lastName} représente un début de saison prometteur sur cette surface. Néanmoins, la question se pose de savoir s'il peut maintenir ce niveau de performance pour le reste de la saison.`;
          of.awayForm_DE =
            of.awayForm_DE +
            ` Die aktuelle Siegquote von ${awayFormOnClay.winPerc}% auf Sand von ${awayData.lastName} stellt einen vielversprechenden Saisonstart auf diesem Belag dar. Es stellt sich jedoch die Frage, ob er dieses Leistungsniveau für den Rest der Saison halten kann.`;
          of.awayForm_CZ =
            of.awayForm_CZ +
            ` Současné procento výher ${awayFormOnClay.winPerc}% na antuce od ${awayData.lastName} představuje slibný začátek sezóny na tomto povrchu. Nicméně se nabízí otázka, zda si tuto úroveň výkonnosti dokáže udržet i po zbytek sezóny.`;
          of.awayForm_PL =
            of.awayForm_PL +
            ` Aktualny procent wygranych ${awayFormOnClay.winPerc}% na glinie przez ${awayData.lastName} prezentuje obiecujący początek sezonu na tej nawierzchni. Niemniej jednak, rodzi się pytanie, czy jest on w stanie utrzymać ten poziom wyników przez resztę sezonu.`;
        }

        if (awayFormOnClay.winPerc < 50 && awayFormOnClay.winPerc >= 40) {
          of.awayForm =
            of.awayForm +
            ` The win percentage of ${awayFormOnClay.winPerc}% on clay by ${awayData.properName} portrays a tough start to the season on this surface. Nonetheless, there is still uncertainty as to whether he can bounce back and deliver a better performance in the upcoming matches of the season.`;
          ...
          of.awayForm_IT =
            of.awayForm_IT +
            ` La percentuale di vittorie di ${awayFormOnClay.winPerc}% sulla terra battuta da parte di ${awayData.properName} evidenzia un inizio di stagione difficile su questa superficie. Ciononostante, non si sa se riuscirà a riprendersi e a fornire prestazioni migliori nelle prossime partite della stagione.`;
          of.awayForm_ES =
            of.awayForm_ES +
            ` El porcentaje de victorias de ${awayFormOnClay.winPerc}% en tierra batida de ${awayData.properName} retrata un duro comienzo de temporada en esta superficie. No obstante, aún no se sabe si podrá recuperarse y ofrecer un mejor rendimiento en los próximos partidos de la temporada.`;
          of.awayForm_PT =
            of.awayForm_PT +
            ` A percentagem de vitórias de ${awayFormOnClay.winPerc}% em terra batida por ${awayData.properName} retrata um início de época difícil nesta superfície. No entanto, ainda não se sabe se ele conseguirá recuperar e apresentar um melhor desempenho nos próximos jogos da época.`;
          of.awayForm_FR =
            of.awayForm_FR +
            ` Le pourcentage de victoire de ${awayFormOnClay.winPerc}% sur terre battue de ${awayData.properName} témoigne d'un début de saison difficile sur cette surface. Néanmoins, l'incertitude demeure quant à sa capacité à rebondir et à réaliser de meilleures performances lors des prochains matches de la saison.`;
          of.awayForm_DE =
            of.awayForm_DE +
            ` Die Gewinnquote von ${awayFormOnClay.winPerc}% auf Sand von ${awayData.properName} zeigt einen schwierigen Saisonstart auf diesem Belag. Dennoch bleibt ungewiss, ob er sich davon erholen und in den kommenden Spielen der Saison eine bessere Leistung abliefern kann.`;
          of.awayForm_CZ =
            of.awayForm_CZ +
            ` Procento výher ${awayFormOnClay.winPerc}% na antuce podle ${awayData.properName} ukazuje těžký začátek sezóny na tomto povrchu. Nicméně stále panuje nejistota, zda se dokáže odrazit ode dna a v nadcházejících zápasech sezony podávat lepší výkony.`;
          of.awayForm_PL =
            of.awayForm_PL +
            ` Procent wygranych ${awayFormOnClay.winPerc}% na glinie przez ${awayData.properName} obrazuje trudny początek sezonu na tej nawierzchni. Mimo to, wciąż nie ma pewności, czy uda mu się odbić od dna i zapewnić lepsze wyniki w nadchodzących meczach sezonu.`;
        }

        if (awayFormOnClay.winPerc < 40) {
          of.awayForm =
            of.awayForm +
            ` It seems that ${awayData.lastName} has had a discouraging start to the season on clay, with a current win percentage of ${awayFormOnClay.winPerc}%. To enhance his results, the player will need to elevate his game.`;

          of.awayForm_RO =
            of.awayForm_RO +
            ` Se pare că ${awayData.lastName} a avut un început de sezon descurajator pe zgură, cu un procentaj actual de victorii de ${awayFormOnClay.winPerc}%. Pentru a-și îmbunătăți rezultatele, jucătorul va trebui să își ridice nivelul de joc.`;
          of.awayForm_IT =
            of.awayForm_IT +
            ` Sembra che ${awayData.lastName} abbia avuto un inizio di stagione scoraggiante sulla terra battuta, con una percentuale di vittorie attuale di ${awayFormOnClay.winPerc}%. Per migliorare i suoi risultati, il giocatore dovrà migliorare il suo gioco.`;
          of.awayForm_ES =
            of.awayForm_ES +
            ` Parece que ${awayData.lastName} ha tenido un comienzo de temporada desalentador en tierra batida, con un porcentaje de victorias actual de ${awayFormOnClay.winPerc}%. Para mejorar sus resultados, el jugador necesitará elevar su juego.`;
          of.awayForm_PT =
            of.awayForm_PT +
            ` Parece que ${awayData.lastName} teve um início de época desanimador no saibro, com uma percentagem de vitórias actual de ${awayFormOnClay.winPerc}%. Para melhorar os seus resultados, o jogador terá de elevar o seu jogo.`;
          of.awayForm_FR =
            of.awayForm_FR +
            ` Il semble que ${awayData.lastName} ait connu un début de saison décourageant sur terre battue, avec un pourcentage de victoire actuel de ${awayFormOnClay.winPerc}%. Pour améliorer ses résultats, le joueur devra élever son niveau de jeu.`;
          of.awayForm_DE =
            of.awayForm_DE +
            ` Es scheint, dass ${awayData.lastName} einen entmutigenden Start in die Saison auf Sand hatte, mit einer aktuellen Siegquote von ${awayFormOnClay.winPerc}%. Um seine Ergebnisse zu verbessern, wird der Spieler sein Spiel verbessern müssen.`;
          of.awayForm_CZ =
            of.awayForm_CZ +
            ` Zdá se, že ${awayData.lastName} má za sebou neutěšený začátek sezóny na antuce, s aktuálním procentem výher ${awayFormOnClay.winPerc}%. Ke zlepšení svých výsledků bude hráč potřebovat zkvalitnit svou hru.`;
          of.awayForm_PL =
            of.awayForm_PL +
            ` Wygląda na to, że ${awayData.lastName}ma zniechęcający początek sezonu na clayu, z aktualnym procentem wygranych ${awayFormOnClay.winPerc}%. Aby poprawić swoje wyniki, zawodnik będzie musiał podnieść poziom swojej gry.`;
        }
      }
      ...
      if (awayFormOnClay.totalMatches >= 5) {
        ...
        if (awayFormOnClay.winPerc >= 80) {
          ...
          if (awayFormOnClay.titles.length > 0) {
            if (awayFormOnClay.titles.length === 1) {
              ...
              of.awayForm_RO =
                of.awayForm_RO +
                ` De asemenea, merită remarcat faptul că ${awayData.lastName} a cucerit un singur titlu pe zgură în acest sezon (${awayFormOnClay.titles[0].titleName}).`;
              of.awayForm_IT =
                of.awayForm_IT +
        ...
        if (awayFormOnClay.winPerc < 50) {
          of.awayForm =
            of.awayForm +
            ` ${awayData.properName}'s performance on clay courts is suboptimal, with a win rate of only ${awayFormOnClay.winPerc}% in his matches played.`;
          of.awayForm_RO =
            of.awayForm_RO +
