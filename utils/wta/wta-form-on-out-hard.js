    ...
    if (match.groundType === 'Hardcourt outdoor') {
      ...
      if (homeFormOnHO.totalMatches >= 1 && homeFormOnHO.totalMatches < 5) {
        ...
        if (homeFormOnHO.winPerc >= 75) {
          of.homeForm =
            of.homeForm +
            ` ${homeData.lastName}'s current win percentage of ${homeFormOnHO.winPerc}% on outdoor hard courts indicates a strong start to the season on this surface. However, it remains to be seen if she can maintain this level of performance as the season progresses.`;
          of.homeForm_RO =
            of.homeForm_RO +
          ...
          of.homeForm_IT =
            of.homeForm_IT +
            ` L'attuale percentuale di vittorie di ${homeData.lastName} di ${homeFormOnHO.winPerc}% sui campi duri all'aperto indica un forte inizio di stagione su questa superficie.`;
          of.homeForm_ES =
            of.homeForm_ES +
            ` El actual porcentaje de victorias de ${homeData.lastName}% de ${homeFormOnHO.winPerc}% en pista dura al aire libre indica un buen comienzo de temporada en esta superficie.`;
          of.homeForm_PT =
            of.homeForm_PT +
            ` A actual percentagem de vitórias de ${homeData.lastName} de ${homeFormOnHO.winPerc}% em campos duros exteriores indica um forte início de época nesta superfície.`;
          of.homeForm_FR =
            of.homeForm_FR +
            ` Le pourcentage de victoire actuel de ${homeData.lastName} de ${homeFormOnHO.winPerc}% sur les courts extérieurs en dur indique un bon début de saison sur cette surface.`;
          of.homeForm_DE =
            of.homeForm_DE +
            ` ${homeData.lastName}s aktueller Gewinnprozentsatz von ${homeFormOnHO.winPerc}% auf Hartplätzen im Freien deutet auf einen starken Start in die Saison auf diesem Belag hin.`;
          of.homeForm_CZ =
            of.homeForm_CZ +
            ` Aktuální procento výher ${homeData.lastName}% na venkovních tvrdých kurtech ${homeFormOnHO.winPerc}% naznačuje silný začátek sezóny na tomto povrchu.`;
          of.homeForm_PL =
            of.homeForm_PL +
            ` Aktualny procent zwycięstw ${homeData.lastName}% na kortach twardych na świeżym powietrzu wskazuje na dobry początek sezonu na tej nawierzchni.`;
        }

        if (homeFormOnHO.winPerc < 75 && homeFormOnHO.winPerc >= 50) {
          of.homeForm =
            of.homeForm +
            ` ${homeData.lastName}'s current win percentage of ${homeFormOnHO.winPerc}% on outdoor hard courts indicates a promising start to the season on this surface. Nonetheless, the question remains whether she can sustain this level of performance throughout the remainder of the season.`;
          of.homeForm_RO =
            of.homeForm_RO +
            ` Procentul actual de victorii al lui ${homeData.lastName} de ${homeFormOnHO.winPerc}% pe terenuri dure în aer liber indică un început de sezon promițător pe această suprafață.`;
          of.homeForm_IT =
            of.homeForm_IT +
            ` L'attuale percentuale di vittorie di ${homeData.lastName}% sui campi duri all'aperto indica un inizio di stagione promettente su questa superficie.`;
          of.homeForm_ES =
            of.homeForm_ES +
            ` El porcentaje de victorias actual de ${homeData.lastName}% de ${homeFormOnHO.winPerc}% en pista dura al aire libre indica un prometedor comienzo de temporada en esta superficie.`;
          of.homeForm_PT =
            of.homeForm_PT +
            ` A actual percentagem de vitórias de ${homeData.lastName} de ${homeFormOnHO.winPerc}% em campos duros exteriores indica um início de época promissor nesta superfície.`;
          of.homeForm_FR =
            of.homeForm_FR +
            ` Le pourcentage de victoire actuel de ${homeData.lastName} de ${homeFormOnHO.winPerc}% sur les courts extérieurs en dur indique un début de saison prometteur sur cette surface.`;
          of.homeForm_DE =
            of.homeForm_DE +
            ` ${homeData.lastName}s aktueller Gewinnprozentsatz von ${homeFormOnHO.winPerc}% auf Hartplätzen im Freien deutet auf einen vielversprechenden Saisonstart auf diesem Belag hin.`;
          of.homeForm_CZ =
            of.homeForm_CZ +
            ` Aktuální procento výher ${homeData.lastName}% na venkovních tvrdých kurtech ${homeFormOnHO.winPerc}% naznačuje slibný začátek sezóny na tomto povrchu.`;
          of.homeForm_PL =
            of.homeForm_PL +
            ` Aktualny procent zwycięstw ${homeData.lastName}% na twardych kortach zewnętrznych wskazuje na obiecujący początek sezonu na tej nawierzchni.`;
        }

        if (homeFormOnHO.winPerc < 50 && homeFormOnHO.winPerc >= 40) {
          of.homeForm =
            of.homeForm +
            ` ${homeData.properName}'s current win percentage of ${homeFormOnHO.winPerc}% on outdoor hard courts suggests a challenging start to the season on this surface. However, the uncertainty still lingers over whether she can recover and showcase a better level of performance in the upcoming matches of the season.`;
          of.homeForm_RO =
            of.homeForm_RO +
            ` Procentul actual de victorii al lui ${homeData.properName} de ${homeFormOnHO.winPerc}% pe terenuri dure în aer liber sugerează un început de sezon dificil pe această suprafață.`;
          of.homeForm_IT =
            of.homeForm_IT +
            ` L'attuale percentuale di vittorie di ${homeData.properName} di ${homeFormOnHO.winPerc}% sui campi duri all'aperto suggerisce un inizio di stagione difficile su questa superficie.`;
          of.homeForm_ES =
            of.homeForm_ES +
            ` El actual porcentaje de victorias de ${homeData.properName}% de ${homeFormOnHO.winPerc}% en pista dura al aire libre sugiere un inicio de temporada complicado en esta superficie.`;
          of.homeForm_PT =
            of.homeForm_PT +
            ` A actual percentagem de vitórias de ${homeData.properName} de ${homeFormOnHO.winPerc}% em campos duros exteriores sugere um início de época difícil nesta superfície.`;
          of.homeForm_FR =
            of.homeForm_FR +
            ` Le pourcentage de victoire actuel de ${homeData.properName} de ${homeFormOnHO.winPerc}% sur les courts extérieurs en dur suggère un début de saison difficile sur cette surface.`;
          of.homeForm_DE =
            of.homeForm_DE +
            ` ${homeData.properName}s aktuelle Siegquote von ${homeFormOnHO.winPerc}% auf Hartplätzen im Freien deutet auf einen schwierigen Saisonstart auf diesem Belag hin.`;
          of.homeForm_CZ =
            of.homeForm_CZ +
            ` Aktuální procento výher ${homeData.properName}% na venkovních kurtech s tvrdým povrchem naznačuje náročný začátek sezóny na tomto povrchu.`;
          of.homeForm_PL =
            of.homeForm_PL +
            ` Aktualny procent zwycięstw ${homeData.properName}% na kortach twardych na świeżym powietrzu sugeruje trudny początek sezonu na tej nawierzchni.`;
        }

        if (homeFormOnHO.winPerc < 40) {
          of.homeForm =
            of.homeForm +
            ` ${homeData.lastName}'s current win percentage of ${homeFormOnHO.winPerc}% on outdoor hard courts suggests a disappointing start to the season on this surface. In order to improve her results, she needs to step up her game and perform at a higher level.`;
          of.homeForm_RO =
            of.homeForm_RO +
            ` Procentul actual de victorii al lui ${homeData.lastName} de ${homeFormOnHO.winPerc}% pe terenuri dure în aer liber sugerează un început de sezon dezamăgitor pe această suprafață.`;
          of.homeForm_IT =
            of.homeForm_IT +
            ` L'attuale percentuale di vittorie di ${homeData.lastName} di ${homeFormOnHO.winPerc}% sui campi duri all'aperto suggerisce un inizio di stagione deludente su questa superficie.`;
          of.homeForm_ES =
            of.homeForm_ES +
            ` El porcentaje de victorias actual de ${homeData.lastName}% de ${homeFormOnHO.winPerc}% en pistas duras al aire libre sugiere un inicio de temporada decepcionante en esta superficie.`;
          of.homeForm_PT =
            of.homeForm_PT +
            ` A actual percentagem de vitórias de ${homeData.lastName} de ${homeFormOnHO.winPerc}% em campos duros exteriores sugere um início de época decepcionante nesta superfície.`;
          of.homeForm_FR =
            of.homeForm_FR +
            ` Le pourcentage de victoire actuel de ${homeData.lastName} de ${homeFormOnHO.winPerc}% sur les courts extérieurs en dur suggère un début de saison décevant sur cette surface.`;
          of.homeForm_DE =
            of.homeForm_DE +
            ` ${homeData.lastName}s aktueller Gewinnprozentsatz von ${homeFormOnHO.winPerc}% auf Hartplätzen im Freien deutet auf einen enttäuschenden Saisonstart auf diesem Belag hin.`;
          of.homeForm_CZ =
            of.homeForm_CZ +
            ` Aktuální procento výher ${homeData.lastName}% na venkovních kurtech s tvrdým povrchem naznačuje, že začátek sezony na tomto povrchu je pro hráče neuspokojivý.`;
          of.homeForm_PL =
            of.homeForm_PL +
            ` Aktualny procent wygranych ${homeData.lastName}% na twardych kortach zewnętrznych sugeruje rozczarowujący początek sezonu na tej nawierzchni.`;
        }
      }
      ...
      if (homeFormOnHO.totalMatches >= 5) {
        ...
        of.homeForm = `In the current season, ${homeData.properName} has played a sufficient number of matches on outdoor hard courts, allowing for a comprehensive analysis of her form on this surface.`;
        ...
        if (homeFormOnHO.winPerc >= 80) {
          of.homeForm =
            of.homeForm +
            ` Her win rate on outdoor hard courts currently stands at an impressive ${homeFormOnHO.winPerc}%, having emerged victorious in ${homeFormOnHO.won} matches and suffered defeat in ${homeFormOnHO.lost}. This performance can certainly be regarded as excellent.`;
          of.homeForm_RO =
            of.homeForm_RO +
        ...
        if (homeFormOnHO.winPerc < 80 && homeFormOnHO.winPerc >= 65) {
          ...
          of.homeForm_RO =
            of.homeForm_RO +
            ` Procentul actual de victorii al lui ${homeData.properName} pe terenuri dure în aer liber este de ${homeFormOnHO.winPerc}%, ceea ce indică o formă generală bună pe această suprafață.`;
          of.homeForm_IT =
            of.homeForm_IT +
        ...
        if (homeFormOnHO.winPerc < 50) {
          of.homeForm =
            of.homeForm +
            ` Her current form on outdoor hard courts is less than ideal, with only a ${homeFormOnHO.winPerc}% win rate in her matches played.`;
          of.homeForm_RO =
            of.homeForm_RO +
      ...
      if (awayFormOnHO.totalMatches >= 1 && awayFormOnHO.totalMatches < 5) {
        ...
        if (awayFormOnHO.winPerc >= 75) {
          of.awayForm =
            of.awayForm +
            ` It appears that ${awayData.lastName} has had a strong start to the season on outdoor hard courts, as indicated by her current win percentage of ${awayFormOnHO.winPerc}%. Nevertheless, it remains to be seen whether she can sustain this level of performance as the season moves forward.`;
          of.awayForm_RO =
            of.awayForm_RO +
          ...
          of.awayForm_IT =
            of.awayForm_IT +
            ` Sembra che ${awayData.lastName} abbia iniziato bene la stagione sui campi duri all'aperto, come indica la sua attuale percentuale di vittorie di ${awayFormOnHO.winPerc}%.`;
          of.awayForm_ES =
            of.awayForm_ES +
            ` Parece que ${awayData.lastName} ha tenido un buen comienzo de temporada en pista dura al aire libre, como indica su actual porcentaje de victorias de ${awayFormOnHO.winPerc}%.`;
          of.awayForm_PT =
            of.awayForm_PT +
            ` Parece que ${awayData.lastName} teve um forte início de época em campos duros exteriores, como indicado pela sua actual percentagem de vitórias de ${awayFormOnHO.winPerc}%.`;
          of.awayForm_FR =
            of.awayForm_FR +
            ` Il semble que ${awayData.lastName} ait connu un bon début de saison sur les courts extérieurs en dur, comme l'indique son pourcentage de victoire actuel de ${awayFormOnHO.winPerc}%.`;
          of.awayForm_DE =
            of.awayForm_DE +
            ` Es scheint, dass ${awayData.lastName} einen starken Start in die Saison auf Hartplätzen im Freien hatte, wie seine aktuelle Gewinnquote von ${awayFormOnHO.winPerc}% zeigt.`;
          of.awayForm_CZ =
            of.awayForm_CZ +
            ` Zdá se, že ${awayData.lastName} má za sebou silný začátek sezóny na venkovních tvrdých kurtech, jak ukazuje jeho aktuální procento výher ${awayFormOnHO.winPerc}%.`;
          of.awayForm_PL =
            of.awayForm_PL +
            ` Wygląda na to, że ${awayData.lastName}ma dobry początek sezonu na twardych kortach, na co wskazuje jego aktualny procent wygranych ${awayFormOnHO.winPerc}%.`;
        }

        if (awayFormOnHO.winPerc < 75 && awayFormOnHO.winPerc >= 50) {
          of.awayForm =
            of.awayForm +
            ` The present win percentage of ${awayFormOnHO.winPerc}% on outdoor hard courts by ${awayData.lastName} presents a promising start to the season on this surface. Nevertheless, it raises the question of whether she can maintain this level of performance for the rest of the season.`;
          of.awayForm_RO =
            of.awayForm_RO +
          ...
          of.awayForm_IT =
            of.awayForm_IT +
            ` L'attuale percentuale di vittorie di ${awayFormOnHO.winPerc}% sui campi duri all'aperto di ${awayData.lastName} rappresenta un inizio di stagione promettente su questa superficie.`;
          of.awayForm_ES =
            of.awayForm_ES +
            ` El actual porcentaje de victorias de ${awayFormOnHO.winPerc}% en pista dura al aire libre de ${awayData.lastName} presenta un prometedor comienzo de temporada en esta superficie.`;
          of.awayForm_PT =
            of.awayForm_PT +
            ` A actual percentagem de vitórias de ${awayFormOnHO.winPerc}% em campos duros exteriores de ${awayData.lastName} apresenta um início de época promissor nesta superfície.`;
          of.awayForm_FR =
            of.awayForm_FR +
            ` Le pourcentage de victoire actuel de ${awayFormOnHO.winPerc}% sur dur en extérieur de ${awayData.lastName} représente un début de saison prometteur sur cette surface.`;
          of.awayForm_DE =
            of.awayForm_DE +
            ` Die aktuelle Siegquote von ${awayFormOnHO.winPerc}% auf Hartplätzen im Freien von ${awayData.lastName} stellt einen vielversprechenden Saisonstart auf diesem Belag dar.`;
          of.awayForm_CZ =
            of.awayForm_CZ +
            ` Současné procento výher ${awayFormOnHO.winPerc}% na venkovních tvrdých kurtech ${awayData.lastName} představuje slibný začátek sezóny na tomto povrchu.`;
          of.awayForm_PL =
            of.awayForm_PL +
            ` Aktualny procent wygranych ${awayFormOnHO.winPerc}% na kortach twardych zewnętrznych przez ${awayData.lastName} prezentuje obiecujący początek sezonu na tej nawierzchni.`;
        }

        if (awayFormOnHO.winPerc < 50 && awayFormOnHO.winPerc >= 40) {
          of.awayForm =
            of.awayForm +
            ` The win percentage of ${awayFormOnHO.winPerc}% on outdoor hard courts by ${awayData.properName} portrays a tough start to the season on this surface. Nonetheless, there is still uncertainty as to whether she can bounce back and deliver a better performance in the upcoming matches of the season.`;
          of.awayForm_RO =
            of.awayForm_RO +
            ` Procentul de victorii de ${awayFormOnHO.winPerc}% pe terenuri dure în aer liber al lui ${awayData.properName} arată un început de sezon dificil pe această suprafață.`;
          of.awayForm_IT =
            of.awayForm_IT +
            ` La percentuale di vittorie di ${awayFormOnHO.winPerc}% sui campi duri all'aperto da parte di ${awayData.properName} evidenzia un inizio di stagione difficile su questa superficie.`;
          of.awayForm_ES =
            of.awayForm_ES +
            ` El porcentaje de victorias de ${awayFormOnHO.winPerc}% en pista dura al aire libre de ${awayData.properName} retrata un duro comienzo de temporada en esta superficie.`;
          of.awayForm_PT =
            of.awayForm_PT +
            ` A percentagem de vitórias de ${awayFormOnHO.winPerc}% em campos duros exteriores por ${awayData.properName} retrata um início de época difícil nesta superfície.`;
          of.awayForm_FR =
            of.awayForm_FR +
            ` Le pourcentage de victoire de ${awayFormOnHO.winPerc}% sur les courts extérieurs en dur de ${awayData.properName} témoigne d'un début de saison difficile sur cette surface.`;
          of.awayForm_DE =
            of.awayForm_DE +
            ` Die Gewinnquote von ${awayFormOnHO.winPerc}% auf Hartplätzen im Freien von ${awayData.properName} zeigt einen schwierigen Saisonstart auf diesem Belag.`;
          of.awayForm_CZ =
            of.awayForm_CZ +
            ` Procento výher ${awayFormOnHO.winPerc}% na venkovních tvrdých kurtech podle ${awayData.properName} ukazuje těžký začátek sezóny na tomto povrchu.`;
          of.awayForm_PL =
            of.awayForm_PL +
            ` Procent zwycięstw ${awayFormOnHO.winPerc}% na kortach twardych na zewnątrz przez ${awayData.properName} obrazuje trudny początek sezonu na tej nawierzchni.`;
        }

        if (awayFormOnHO.winPerc < 40) {
          of.awayForm =
            of.awayForm +
            ` It seems that ${awayData.lastName} has had a discouraging start to the season on outdoor hard courts, with a current win percentage of ${awayFormOnHO.winPerc}%. To enhance her results, the player will need to elevate her game.`;
          of.awayForm_RO =
            of.awayForm_RO +
            ` Se pare că ${awayData.lastName} a avut un început de sezon descurajator pe terenurile hard în aer liber, cu un procentaj actual de victorii de ${awayFormOnHO.winPerc}%.`;
          of.awayForm_IT =
            of.awayForm_IT +
            ` Sembra che ${awayData.lastName} abbia avuto un inizio di stagione scoraggiante sui campi duri all'aperto, con una percentuale di vittorie attuale di ${awayFormOnHO.winPerc}%.`;
          of.awayForm_ES =
            of.awayForm_ES +
            ` Parece que ${awayData.lastName} ha tenido un comienzo de temporada desalentador en pistas duras exteriores, con un porcentaje de victorias actual de ${awayFormOnHO.winPerc}%.`;
          of.awayForm_PT =
            of.awayForm_PT +
            ` Parece que ${awayData.lastName} teve um início de época desanimador em campos duros exteriores, com uma percentagem de vitórias actual de ${awayFormOnHO.winPerc}%.`;
          of.awayForm_FR =
            of.awayForm_FR +
            ` Il semble que ${awayData.lastName} ait connu un début de saison décourageant sur les courts extérieurs en dur, avec un pourcentage de victoire actuel de ${awayFormOnHO.winPerc}%.`;
          of.awayForm_DE =
            of.awayForm_DE +
            ` Es scheint, dass ${awayData.lastName} einen entmutigenden Start in die Saison auf Hartplätzen im Freien hatte, mit einer aktuellen Gewinnquote von ${awayFormOnHO.winPerc}%.`;
          of.awayForm_CZ =
            of.awayForm_CZ +
            ` Zdá se, že ${awayData.lastName} má za sebou neutěšený začátek sezóny na venkovních tvrdých površích, s aktuálním procentem výher ${awayFormOnHO.winPerc}%.`;
          of.awayForm_PL =
            of.awayForm_PL +
            ` Wygląda na to, że ${awayData.lastName}ma zniechęcający początek sezonu na twardych kortach na zewnątrz, z aktualnym procentem wygranych ${awayFormOnHO.winPerc}%.`;
        }
      }
      ...
      if (awayFormOnHO.totalMatches >= 5) {
        // console.log(`win perc ${awayFormOnHO.winPerc}%`);
        of.awayForm = `During this season, ${awayData.properName} has played an adequate amount of matches on outdoor hard courts, thus enabling a thorough evaluation of her form on this surface.`;
        ...
        if (awayFormOnHO.winPerc < 50) {
          of.awayForm =
            of.awayForm +
            ` ${awayData.properName}'s performance on outdoor hard courts is not good, with a win rate of only ${awayFormOnHO.winPerc}% in her matches played.`;
          of.awayForm_RO =
            of.awayForm_RO +
